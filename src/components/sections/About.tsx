        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              I'm a passionate fullstack developer with 6+ years of experience creating 
              intuitive web applications that focus on both functionality and aesthetics. 
              I studied at Stockholm Futuregames and have been crafting exceptional 
